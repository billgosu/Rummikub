...
public class Ui extends Application
{
	...
	public void start(Stage primaryStage) throws Exception 
	{
		...
		InputStream mainImagePath = null;
		try {
			mainImagePath = new FileInputStream("C:\\Users\\phamv\\OneDrive\\Desktop\\Carleton\\Fall2018\\3004\\Iteration1\\Comp3004RummikubTeam31\\src\\main\\resources//TitleImage.png");
		...
		InputStream iconImagePath = new FileInputStream("C:\\Users\\phamv\\OneDrive\\Desktop\\Carleton\\Fall2018\\3004\\Iteration1\\Comp3004RummikubTeam31\\src\\main\\resources\\iconImage.png");
	...
	protected void fileInput() {
		...
		//nputStream mainImagePath = getClass().getResourceAsStream("pickOne.png");
		InputStream mainImagePath = null;
		try {
			mainImagePath = new FileInputStream("C:\\Users\\phamv\\OneDrive\\Desktop\\Carleton\\Fall2018\\3004\\Iteration1\\Comp3004RummikubTeam31\\src\\main\\resources\\pickOne.png");
		} catch (FileNotFoundException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
	...
	private boolean checkAIIsWinner() {
    	...
    	for(int i =0; i < game.getPlayers().size()-1;i++) {
    		if(game.getPlayers().get(i).getHand().sizeOfHand() == 0) {
    			...
    			InputStream mainImagePath = null;
				try {
					mainImagePath = new FileInputStream("C:\\Users\\phamv\\OneDrive\\Desktop\\Carleton\\Fall2018\\3004\\Iteration1\\Comp3004RummikubTeam31\\src\\main\\resources//Looser.jpg");
				} catch (FileNotFoundException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
	...
	private boolean checkPlayerIsWinner() {
		...
		if(pointer.getHand().sizeOfHand() == 0) {
			InputStream mainImagePath= null;
			try {
				mainImagePath = new FileInputStream("C:\\Users\\phamv\\OneDrive\\Desktop\\Carleton\\Fall2018\\3004\\Iteration1\\Comp3004RummikubTeam31\\src\\main\\resources//Winner.jpg");
			} catch (FileNotFoundException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
			}
